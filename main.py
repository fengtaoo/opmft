...
def procees_for_infer(args):
    ...
    if args.reinfoselect:
        infer(args, model, policy, loss_fn, m_optim, m_scheduler, p_optim, metric, train_loader,
                           dev_loader, device)
    else:
        dev_loader_2 = None
...
def main():
    ...
    if args.infer is True:
        procees_for_infer(args)
    else:
        process_for_train(args)
